...
- (void)viewDidLoad {
    ...
    dispatch_queue_t queue=dispatch_queue_create("com.sky.ffmpeg", DISPATCH_QUEUE_CONCURRENT);
    ...
    while(1)
    {
        ...
        if (packet->stream_index==videoStream)
        {
            ...
            if (got_picture)
            {
                ...
                {
                    NSString *file=[NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"%d.ppm",index]];
                    
                    FILE *pFile=fopen(file.UTF8String, "wb");
                    ...
                    {
                        fwrite(pFrameRGB->data[0]+y*pFrameRGB->linesize[0], 1, width, pFile);
                    }
